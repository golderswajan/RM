...
//        }
    ...
    function getRowHtml(index,primaryKeyValue,parentRowNo,foodName,price,quantity=1){
        var rowHtml ="<div class=\"row order\" id=\"div"+index+"\">\n" +
            ...
            "                    <div class=\"col-lg-2 col-md-2 col-sm-2 form-group\"><input type=\"number\" class=\"form-control\" style=\"font-size: small;width:70%\" min=\"1\" id=\"amount"+index+"\" name=\"amount"+index+"\" value=\""+quantity+"\" onkeyup=\"measureCost('"+index+"')\" required></div>\n" +
